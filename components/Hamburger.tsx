...
const Dropdown = () => {
  ...
  <ChevronDownIcon style={{ width: '10px', height: '10px', marginTop: '4px' }} />
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content className="mx-0 rounded-lg transition duration-300 ease-in-out min-w-[220px] absolute top-0 left-0 right-0 w-screen  bg-black absolute bg-opacity-60 backdrop-blur   p-[5px] shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)] will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade">
          {menuItems.map((item) => (
            <DropdownMenu.Item
              key={item.url}
