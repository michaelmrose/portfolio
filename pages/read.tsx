...
function read() {
  return (
    <article className="format dark:format-invert mt-16 mx-auto">
      ...
      <div className="flex my-2 item-stretch">
        <Profile />
        <time className="ml-2 self-center">
          November 8th, 2022
        </time>
      </div>
      <p>
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatum,
        omnis accusantium! Hic ipsa repudiandae, quibusdam autem dolor earum
        labore vero voluptatem! Quaerat aliquam pariatur ex cumque sint quas ad
        rerum.
      </p>
      <p>
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Asperiores
        quae culpa corporis quia ipsa saepe magni recusandae nihil impedit
        assumenda? Porro veniam consequatur adipisci, iure delectus cupiditate
        illo voluptate magni error aliquid vitae repudiandae, eligendi itaque,
        id explicabo corporis! Iusto vel minima, quam adipisci corporis
        incidunt. Saepe animi eaque natus vel provident velit autem officiis
        tenetur, eos fugit neque quia at ut odit iusto ea explicabo, totam
        blanditiis. Cum suscipit corporis in quae vel possimus eaque dolorum
        necessitatibus amet alias corrupti id, perspiciatis laudantium, numquam,
        iure fugiat. Laudantium rem id ipsam? Ipsa earum mollitia enim corporis
        pariatur repellendus magni numquam.
      </p>
      ...
      <p>
        But then I found a{" "}
        <a href="#">component library based on Tailwind CSS called Flowbite</a>.
