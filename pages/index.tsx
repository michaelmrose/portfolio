...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        <h1 className="text-4xl font-bold tracking-tight text-slate-200 sm:text-5xl">Michael Rose</h1>
        <h2 className="mt-3 text-lg font-bold tracking-tight text-slate-200 sm:text-xl">Full-Stack Developer in Seattle</h2>
        <p className="mt-4 max-w-xs leading-normal">I build websites</p>
